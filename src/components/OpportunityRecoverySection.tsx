      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          <div className="lg:col-span-5">
            ...
            <div className="mt-8 border border-[#E5E5E5] bg-[#F7F7F5] p-4 rounded-2xl">
          ...
          <div className="lg:col-span-7 border border-[#E5E5E5] bg-[#F7F7F5] rounded-3xl overflow-hidden">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative flex justify-center">
                      <div className="w-8 h-8 border border-[#D8D8D8] bg-[#F7F7F5] rounded-xl flex items-center justify-center">
