      ...
      <div>
        ...
        <div className="mb-6">
          ...
          <p className="text-xs text-[#6B6B6B] font-mono-code">
            Intent: <span className="text-[#0A0A0A] font-semibold">{selectedLead.intention}</span>
          </p>
        </div>
        ...
        <div className="space-y-2.5 mb-6 text-xs font-mono-code pb-6 border-b border-[#E5E5E5]">
          ...
          <div className="flex justify-between py-1 border-b border-[#E5E5E5]/60">
            <span className="text-[#6B6B6B]">NEXT ACTION</span>
            <span className="text-[#0A0A0A] font-semibold">{selectedLead.nextAction}</span>
          </div>
          <div className="flex justify-between py-1 border-b border-[#E5E5E5]/60">
            <span className="text-[#6B6B6B]">LAST TOUCH</span>
      ...
      <div className="pt-4 border-t border-[#E5E5E5]">
        <div className="p-4 bg-white border border-[#E5E5E5] mb-4">
          ...
          <p className="text-xs text-[#6B6B6B] leading-relaxed mb-3">
            Request an audit to identify where your commercial inquiries are stalling and how an automated system can recover them.
          </p>
          <button
            type="button"
            onClick={onOpenAudit}
