      ...
      <table className="w-full text-left text-xs border-collapse" role="table" aria-label="Commercial leads table">
        <thead>
          <tr className="border-b border-[#E5E5E5] font-mono-code text-[11px] text-[#6B6B6B] bg-[#FAFAFA]">
            ...
            <th scope="col" className="py-3 px-3 font-semibold uppercase">Intention</th>
            <th scope="col" className="py-3 px-3 font-semibold uppercase">Priority</th>
            <th scope="col" className="py-3 px-3 font-semibold uppercase">Status</th>
            <th scope="col" className="py-3 px-4 font-semibold uppercase text-right">Next Action</th>
          </tr>
        </thead>
          ...
          {leads.length > 0 ? (
            ...
            <tr>
              <td colSpan={5} className="py-12 text-center text-[#6B6B6B]">
                <p className="font-mono-code text-xs mb-2">No leads match the selected criteria ({activeFilter}).</p>
                <button
                  type="button"
